...
const Navbar = () => {
    ...
    const navLinks = [
        { name: 'Home', href: '/' },
        {
            ...
            href: '#',
            dropdown: [
                { name: 'MBBS in Australia', href: '/study-mbbs-in-australia' },
                { name: 'MBBS in Bangladesh', href: '/study-mbbs-in-bangladesh' },
                { name: 'MBBS in China', href: '/study-mbbs-in-china' },
                { name: 'MBBS in Europe', href: '/study-mbbs-in-europe' },
                { name: 'MBBS in Georgia', href: '/study-mbbs-in-georgia' },
                { name: 'MBBS in Germany', href: '/study-mbbs-in-germany' },
                { name: 'MBBS in India', href: '/study-mbbs-in-india' },
                { name: 'MBBS in Kazakhstan', href: '/study-mbbs-in-kazakhstan' },
                { name: 'MBBS in Kyrgyzstan', href: '/study-mbbs-in-kyrgyzstan' },
                { name: 'MBBS in Mauritius', href: '/study-mbbs-in-mauritius' },
                { name: 'MBBS in Nepal', href: '/study-mbbs-in-nepal' },
                                            ...
                                            <div className="grid grid-cols-2 gap-3">
                                                {link.dropdown.map(sublink => (
                                                    <a
                                                        key={sublink.name}
                                                        href={sublink.href}
                                                        className="flex items-center text-[13px] font-semibold text-[#0E0C4F] bg-[#F8FAFC] hover:bg-[#F0F7FF] hover:text-[#164E8E] rounded-xl px-4 py-3 transition-all duration-200 border border-gray-100 hover:border-[#BFDBFE] hover:shadow-sm truncate"
                                                        onClick={() => setIsOpen(false)}
                                                    >
                                                        {sublink.name.replace('MBBS in ', '')}
                                                    </a>
                                                ))}
                                            </div>
                                        </div>
