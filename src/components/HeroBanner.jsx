...
const HeroBanner = () => {
    return (
        <section className="relative w-full bg-[#F0F7FF] overflow-hidden min-h-[400px] flex items-center">
            ...
            <div
                className="absolute bottom-0 left-0 w-[45%] h-full bg-[#0E0C4F] opacity-90 hidden md:block -z-0"
                style={{ clipPath: 'polygon(0 0, 60% 0, 100% 50%, 75% 100%, 0 100%)' }}
            />
            <div className="absolute top-0 right-0 w-1/4 h-24 bg-[#0E0C4F] rounded-bl-full opacity-90 -z-0" />
            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-12 items-end gap-8">
                    ...
                    {/* Right: Text Content */}
                    <div className="md:col-span-7 text-center md:text-right flex flex-col items-center md:items-end mb-8">
                        ...
                        <button className="bg-[#164E8E] text-white px-10 py-3 rounded-full font-bold text-lg shadow-lg hover:bg-[#0E3563] transition-all transform hover:scale-105">
                            Find Out More
                        </button>
                    </div>
